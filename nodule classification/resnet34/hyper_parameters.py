...
a random batch''')
tf.app.flags.DEFINE_integer('train_batch_size', 75, '''Train batch size''')
tf.app.flags.DEFINE_integer('validation_batch_size', 75, '''Validation batch size, better to be
a divisor of 10000 for this task''')
tf.app.flags.DEFINE_integer('test_batch_size', 109, '''Test batch size''')
